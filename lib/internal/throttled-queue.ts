...
exports.inject = function(wait: Function, getTime: Function) {
  return {
    /**
     ...
     */
    create: function(limit: number, period: number) {
      var me: any = {};
       ...
       * @template T
       */
      me.add = function(doSomething: Function) {
        ...
        var waitForMyTurn = Task
            .start(function(resolve: Function) {
