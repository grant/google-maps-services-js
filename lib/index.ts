...
export const createClient = (options: any) => {
  ...
  var makeApiMethod = function(apiConfig: any) {
    return function(query: any, callback: Function, customParams: Object) {
...
export const cli = internalcli;
export const util = internalutil;
